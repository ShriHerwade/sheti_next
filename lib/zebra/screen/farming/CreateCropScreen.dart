    ...
    if (_formKey.currentState!.validate()) {
      try {
        CropModel crop = CropModel(
          ...
          area: double.parse(_confarmArea.text ?? '0.0'),
          unit: selectedUnit!,
          startDate: startDate!,
          endDate: endDate!,
          cropLifeState: "Live",
          stateUpdatedDate: DateTime.now(),
          expectedIncome: (_conExpectedIncome.text != null && _conExpectedIncome.text.isNotEmpty) ? double.parse(_conExpectedIncome.text!) : 0.0,
          expectedYield: double.parse(_conExpectedYield.text ?? '0.0'),
          expectedYieldUnit: selectedYieldUnit!,
          totalExpense: 0.0,
          totalIncome: 0.0,
          totalYield: 0.0,
          totalYieldUnit: selectedYieldUnit!,
          isActive: true,
          isExpanded: true,
