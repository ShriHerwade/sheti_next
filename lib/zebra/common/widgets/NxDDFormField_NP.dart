...
class NxDDFormField_NP extends StatefulWidget {
  final String? value;
  final String label;
  final String hint;
  ...
  @override
  State<NxDDFormField_NP> createState() =>
      _NxDDFormField_NPState();
}

class _NxDDFormField_NPState extends State<NxDDFormField_NP> {
  @override
